...
| **melotts** | [`myshell-ai/MeloTTS`](https://github.com/myshell-ai/MeloTTS) EN_V2 | VITS2 (6L transformer + SDP/DP + 4-block transformer coupling flow + HiFi-GAN); 44.1 kHz mono, ~97 MB F16; 4 EN speakers ([more](docs/architecture.md#melotts)) | en | MIT |
